...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		try {
			jumpSound =  Applet.newAudioClip(this.getClass().getResource("../audios/jump.wav"));
			//jumpSound =  Applet.newAudioClip(new URL("file","","data/jump.mp3"));
			//deadSound =  Applet.newAudioClip(new URL("file","","data/dead.mp3"));
			deadSound =  Applet.newAudioClip(this.getClass().getResource("../audios/dead.wav"));
			scoreUpSound =  Applet.newAudioClip(new URL("file","","src/audios/scoreup.wav"));
